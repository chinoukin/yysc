...
public class OrdInvoGetVo {
    ...
    @ApiModelProperty(value = "上传电子发片的图片地址")
    private EleInvoFileGetVo eleInvoUrlVo;

    public EleInvoFileGetVo getEleInvoUrlVo() {
        return eleInvoUrlVo;
    }

    public void setEleInvoUrlVo(EleInvoFileGetVo eleInvoUrlVo) {
        this.eleInvoUrlVo = eleInvoUrlVo;
    }
