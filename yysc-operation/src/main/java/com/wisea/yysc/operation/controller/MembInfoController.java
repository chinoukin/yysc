...
import com.wisea.yysc.common.po.memb.MembInfoDelPo;
import com.wisea.yysc.common.po.memb.MembInfoFindPo;
import com.wisea.yysc.common.po.memb.RegisterMembPo;
import com.wisea.yysc.common.po.memb.UpdMembPo;
...
public class MembInfoController {
   ...
   private MembInfoService membInfoService;
     ...
     * @version 1.0
     */
    @ApiOperation(value = "修改会员的接口")
    @PostMapping(value = { "/updUserMemb" })
    @DataCheck
    public ResultPoJo<String> updUserMemb(@RequestBody UpdMembPo po){
        // 处理并且返回
        return membInfoService.updUserMembInfo(po);
    }
